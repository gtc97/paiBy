<template>
  <div class="container">
    ...
    />
    <div class="logo"/>
    <img src="/static/shoplogo.png" style="width: 40%;margin-left:30%" alt="">
    <div class="login-wrap">
      ...
      <div class="input-wrap vercode-box">
        <input v-model="loginForm.code" type="text" placeholder="请输入短信验证码" maxlength="6">
        <span class="codenotice" @click="handleGetVerificationCode">{{ loginForm.notice }}</span>
      </div>
      <div class="agreement">
...
export default {
  ...
  methods: {
    ...
    handleGetVerificationCode() {
      ...
      this.$api.verificationCode({ userPhone: this.loginForm.userPhone, function: 'login' }).then(res => {
        if (res.status === 1) {
          this.overtime(60)
          Toast(res.msg)
        } else {
...
<style lang="less" scoped>
  .container {
    ...
    .login-wrap {
      box-sizing: border-box;
      padding: .5333rem /* 40/75 */ 0.4rem /* 30/75 */ 0.2667rem /* 20/75 */;
