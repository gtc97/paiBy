<template>
    <div class="container">
        ...
        <div class="item-list">
            <div v-for="item of toBePaid" :key="item.id" class="item" to="/">
                <div class="item-header">
                    <p data-v-2c8a74d2 v-if="item.status==2" style="font-size:0.32rem;float:right" >买方电话：{{item.userPhone}}</p>
                ...
                <div class="item-button">
                    <div v-if="item.status == 2" class="pay" @click="handleSellOrder(item.id)">确认收款</div>
