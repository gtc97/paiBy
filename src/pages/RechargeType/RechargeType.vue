    ...
    <div class="container rechargetype">
        ...
        <div class="pay-type">
            ...
            <div v-if="radio==1">
                ...
                <ul style="font-size: 0.4em;line-height: 2em;width: 88%;padding-top:1em">
                    <li>
            ...
            <div v-if="radio==3">
                ...
                <ul style="font-size: 0.4em;line-height: 2em;padding-top:1em">
                    ...
                    <li>
                        <img :src="userPayInfo.weixin.img" style="width:40vh height:40vh" alt />
                    </li>
                </ul>
            </div>
            ...
            <ul style="font-size: 0.4em;line-height: 2em;padding-top:1em;">
                <div class="ercode" style="margin:auto;width:6.2em;">
                    <van-uploader v-model="fileList" :max-count="1" upload-icon="plus" multiple />
                </div>
            </ul>
            ...
            <div class="submit-btn" @click="handlePay">立即充值</div>
        </div>
    </div>
</template>
...
export default {
        ...
        fileList() {
            if (this.fileList.length > 0) {
                ...
                return new Promise((resolve, reject) => {
                    axios
                        .post(
                            baseConfig.apiurl + "/api/common/uploadPic",
                            params,
                            config
                        )
                        .then(res => {
    ...
    methods: {
        ...
        handlePay() {
            ...
            this.$api.recharge({ money: this.money, type: this.radio ,img:this.payImgUrl})
                .then(res => {
                    Toast("支付凭证上传成功等待审核");
